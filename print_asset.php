...
$output = '';
	...
	$query = "select * from asset_table where cat='CPU' AND branch_name='$branch_name'";
...
<center><h1 class="w3-red">SUBMIT ASSET AFTER COMPLETION</h1></center>
<center ><h1 style="color:red;" >|</h1></center>
<center ><h1 style="color:red;" >|</h1></center>
<center ><h1 style="color:red;" >|</h1></center>
<center ><h1 style="color:red;" >|</h1></center>
<center ><h1 style="color:red;" >\/</h1></center>
<center><button class="w3-button w3-red" onclick="window.location.href ='final_asset_submit.php?branch_name=<?php echo $_SESSION["branch_name"]; ?>&ifsc=<?php echo $_SESSION["ifsc"]; ?>';">SUBMIT ASSET AS FINAL</button></center>



<br/>
<center>
<button  class="w3-button w3-red"onclick="window.open('print_asset_auto.php?branch_name=<?php echo $_SESSION["branch_name"]; ?>&ifsc=<?php echo $_SESSION["ifsc"]; ?>&bank_name=<?php echo $_SESSION["bank_name"]; ?>','popUpWindow','height=500,width=400,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');">PRINT ASSET</button></center>
